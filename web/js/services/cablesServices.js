...
/**
 * Méthode qui grise ou dégrise les onglets dans le bloc 'Tableau'
 */
app.service('enabledTabs', function($rootScope){

    // this.setEnabledTabs = function(pKey, pValDisabled){
    //     if (pKey === "zonessensibles"){
    //         $rootScope.tabs[0].disabled = pValDisabled;
    //     }
    //     if (pKey === "mortalites"){
    //         $rootScope.tabs[1].disabled = pValDisabled;
    //     }
    //     if (pKey === "tronconserdf"){
    //         $rootScope.tabs[2].disabled = pValDisabled;
    //     }
    //     if (pKey === "poteauxerdf"){
    //         $rootScope.tabs[3].disabled = pValDisabled;
    //     }
    //     if (pKey === "eqtronconserdf"){
    //         $rootScope.tabs[4].disabled = pValDisabled;
    //     }
    //     if (pKey === "eqpoteauxerdf"){
    //         $rootScope.tabs[5].disabled = pValDisabled;
    //     }
    //     if (pKey === "nidifications"){
    //         $rootScope.tabs[6].disabled = pValDisabled;
    //     }
    //     if (pKey === "observations"){
    //         $rootScope.tabs[7].disabled = pValDisabled;
    //     }   
    // }
});
 ...
 * Méthode qui grise ou dégrise les onglets dans le bloc 'Tableau'
 */
app.service('activeTabs', function($rootScope){

    this.setActiveTabs = function(pKey, pValActive){
        if (pKey === "zonessensibles"){
            $rootScope.tabs[0].active = pValActive;
        }
        if (pKey === "mortalites"){
            $rootScope.tabs[1].active = pValActive;
        }
        if (pKey === "tronconserdf"){
            $rootScope.tabs[2].active = pValActive;
        }
        if (pKey === "poteauxerdf"){
            $rootScope.tabs[3].active = pValActive;
        }
        if (pKey === "eqtronconserdf"){
            $rootScope.tabs[4].active = pValActive;
        }
        if (pKey === "eqpoteauxerdf"){
            $rootScope.tabs[5].active = pValActive;
        }
        if (pKey === "nidifications"){
            $rootScope.tabs[6].active = pValActive;
        }
        if (pKey === "observations"){
            $rootScope.tabs[7].active = pValActive;
        }   
    }
});
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
