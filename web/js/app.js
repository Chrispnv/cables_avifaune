var app = angular.module('appCables', [ 'cablesGlobalCtrl', 'mortalitesCtrl', 'zonesSensiblesCtrl', 'tronconsErdfCtrl', 'eqTronconsErdfCtrl', 'eqPoteauxErdfCtrl','nidificationsCtrl','observationsCtrl', 'poteauxErdfCtrl', 'photosPoteauxErdfCtrl', 'photosTronconsErdfCtrl', 'cablesServices', 'FormDirectives', 'DisplayDirectives', 'ui.bootstrap', 'bootstrap.tabset', 'darthwade.loading', 'mapServices', 'LocalStorageModule']); //'ngTableResizableColumns'
...
// module de gestion des équipements tronçons erdf
angular.module('photosTronconsErdfCtrl', ['cablesServices', 'mapServices','ngRoute', 'ngTable']);
...
// module de gestion des équipements poteaux erdf
angular.module('photosPoteauxErdfCtrl', ['cablesServices', 'mapServices','ngRoute', 'ngTable']);
...
angular.module('FormDirectives', ['ngFileUpload', 'angularFileUpload','mapServices']);
